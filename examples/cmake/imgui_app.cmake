...
# System options
set(IMGUI_APP_SYSTEM_EMSCRIPTEN OFF)
if(EMSCRIPTEN)
  set(IMGUI_APP_SYSTEM_EMSCRIPTEN ON)
  target_compile_definitions(imgui_app PUBLIC IMGUI_APP_SYSTEM_EMSCRIPTEN)
endif()
...
if(IMGUI_APP_SYSTEM_EMSCRIPTEN)
  set(IMGUI_APP_PLATFORM "SDL2")
endif()
...
if(IMGUI_APP_SYSTEM_EMSCRIPTEN)
  set(IMGUI_APP_RENDERER "OPENGL3")
endif()
...
if(NOT IMGUI_APP_RENDERER_OPENGL3)
  # unnecessary
elseif(IMGUI_APP_SYSTEM_EMSCRIPTEN)
  # unnecessary
