...
if(IMGUI_IMPL_RENDERER_OPENGL2 OR IMGUI_IMPL_RENDERER_OPENGL3) # OpenGL
  ...
  if(IMGUI_IMPL_RENDERER_OPENGL2)
    target_sources(imgui_impl_renderer PRIVATE ${IMGUI_IMPL_RENDERER_SOURCE_DIR}/imgui_impl_opengl2.cpp)
  elseif(IMGUI_IMPL_RENDERER_OPENGL3)
    target_sources(imgui_impl_renderer PRIVATE ${IMGUI_IMPL_RENDERER_SOURCE_DIR}/imgui_impl_opengl3.cpp)
  endif()
...
elseif(IMGUI_IMPL_RENDERER_VULKAN) # Vulkan
  ...
  target_sources(imgui_impl_renderer PRIVATE ${IMGUI_IMPL_RENDERER_SOURCE_DIR}/imgui_impl_vulkan.cpp)
